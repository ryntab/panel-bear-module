...
export declare const load: (site: string, config?: PanelbearConfig | undefined) => void;
export declare const trackPageview: () => void;
export declare const config: (config: PanelbearConfig) => void;
export declare const track: (eventName: string) => void;
export {};
